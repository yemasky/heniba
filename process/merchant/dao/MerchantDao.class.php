...
class MerchantDao extends \BaseDao {
	...
	public function getMerchant($conditions, $fileid = NULL) {
		...
		return \DBQuery::instance(\DbConfig::merchant_dsn)->setTable('merchant')->setKey('m_id')->order($conditions['order'])->limit($conditions['limit'])->getList($conditions['condition'], $fileid);
	}
}