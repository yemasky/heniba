...
CREATE TABLE `hotel` (
  ...
  `hb_id` int(11) DEFAULT NULL COMMENT 'brand ID',
  ...
  `h_images` varchar(300) DEFAULT NULL COMMENT '图片',
  ...
  FULLTEXT KEY `hotel` (`h_name`,`h_attr1_value`,`h_attr2_value`,`h_attr3_value`,`h_attr4_value`,`h_attr5_value`)
...
CREATE TABLE `order_info` (
  ...
  `oi_user_leave_date` datetime DEFAULT NULL COMMENT '离开时间',
  `oi_user_message` varchar(200) DEFAULT NULL COMMENT '用户留言',
  `oi_user_options` varchar(10) DEFAULT NULL,
  `oi_user_pax` varchar(5) DEFAULT NULL COMMENT '人数',
  `oi_user_childen` varchar(5) DEFAULT NULL COMMENT '孩子数',
...
CREATE TABLE `tourism` (
  ...
  `t_price_low` float DEFAULT NULL COMMENT '最低价格',
