<?php /* Smarty version Smarty-3.0.6, created on 2015-10-26 00:01:31
         compiled from "E:\WEB\heniba\templates/www/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12955562cfcdb7e43a2-00640605%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b870475969dffe2b6a36544b1f4cc6a83fd20bbe' => 
    array (
      0 => 'E:\\WEB\\heniba\\templates/www/index.tpl',
      1 => 1445788890,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12955562cfcdb7e43a2-00640605',
  'function' => 
  array (
  ),
...
<html>
	<head>
	<?php $_template = new Smarty_Internal_Template("inc/#head.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
				...
				<div id="main-header">
					...
					<div class="row">
						...
						<div id="logo" class="col-lg-3 col-md-3 col-sm-3">		
							<a href="main-v1.html"><img src="<?php echo $_smarty_tpl->getVariable('__RESOURCE')->value;?>
...
js/owl.carousel.min.js"></script>
		...
		<!-- Revolution Slider  -->
		<script type="text/javascript" src="<?php echo $_smarty_tpl->getVariable('__RESOURCE')->value;?>
js/revolution-slider/js/jquery.themepunch.plugins.min.js"></script>
		<script type="text/javascript" src="<?php echo $_smarty_tpl->getVariable('__RESOURCE')->value;?>
js/revolution-slider/js/jquery.themepunch.revolution.min.js"></script>
		
		<!-- Calendar -->
		<script type="text/javascript" src="<?php echo $_smarty_tpl->getVariable('__RESOURCE')->value;?>
js/responsive-calendar.min.js"></script>
...
js/chosen.jquery.min.js"></script>
		...
		<!-- InstaFeed -->
		<script type="text/javascript" src="<?php echo $_smarty_tpl->getVariable('__RESOURCE')->value;?>
js/instafeed.min.js"></script>
		
		<!-- Twitter -->
		<script type="text/javascript" src="<?php echo $_smarty_tpl->getVariable('__RESOURCE')->value;?>
php/twitter/jquery.tweet.js"></script>
		
		<!-- MixItUp -->
		<script type="text/javascript" src="<?php echo $_smarty_tpl->getVariable('__RESOURCE')->value;?>
js/jquery.mixitup.js"></script>
		
		<!-- JackBox -->
		<script type="text/javascript" src="<?php echo $_smarty_tpl->getVariable('__RESOURCE')->value;?>
jackbox/js/jackbox-packed.min.js"></script>
		
		<!-- CloudZoom -->
		<script type="text/javascript" src="<?php echo $_smarty_tpl->getVariable('__RESOURCE')->value;?>
js/zoomsl-3.0.min.js"></script>
