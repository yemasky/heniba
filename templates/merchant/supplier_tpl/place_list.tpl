  ...
  <div class="am-list-news-bd">
    <ul class="am-list">
      ...
      <li class="am-g am-list-item-dated">
        <a href="##" class="am-list-item-hd" city="<%$arrayPlace[place].c_city_id%>" data-id="<%$arrayPlace[place].c_type%>" data-name="<%$arrayPlace[place].c_name%>"><%$arrayPlace[place].c_name_cn%></a>
